...
#based entirely in https://wyag.thb.lt
import argparse
import configparser
...
argparser = argparse.ArgumentParser(description="Learning to make a content tracker")
...
def repo_find(path=".", required=True):
    """ Function that looks for the root of the current directory and allows recursing back to / """
...
############################## Where the subparsers are defined
...
##################################### Where all the commands are defined: Check Main for more details
...
###################################Base implementation for GitObject
